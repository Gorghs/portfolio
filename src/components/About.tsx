...
const AwardWinningAbout: React.FC = () => {
    ...
    const stats = [
        { label: "EXP_YRS", value: "03+", desc: "Years in Automation Systems" },
        { label: "PRJ_CMP", value: "12+", desc: "Systems & Prototypes Built" },
        { label: "FOCUS", value: "AI", desc: "Workflow Intelligence" },
                ...
                <div className="mb-16 md:mb-24 relative">
                    ...
                    <div className="about-content-item relative md:absolute md:top-1/2 left-0 md:left-1/4 mt-12 md:mt-0 ml-0 md:ml-20 transform md:-translate-y-1/2 w-full md:w-2/3 pl-6 border-l-2 border-red-500">
                        <p className="text-lg md:text-2xl font-light leading-relaxed text-black dark:text-white mix-blend-difference">
                            I am <span className="font-bold">Karthick Venkatachalem</span>, an <span className="font-bold text-red-500">AI Systems Developer</span> focused on practical automation that reduces human effort and increases operational efficiency.
                        </p>
                        <p className="text-lg md:text-2xl font-light leading-relaxed text-black dark:text-white mix-blend-difference mt-6">
                            I build <span className="font-bold">n8n workflow systems</span>, <span className="font-bold">embedding-driven semantic engines</span>, and <span className="font-bold">backend decision pipelines</span> with a strong emphasis on deterministic behavior, portability, and scalable execution.
                        </p>
                    </div>
                </div>
