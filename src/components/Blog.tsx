  ...
  const blogs = [
    {
      ...
      date: 'Dec 15, 2024',
      readTime: '8 min read',
      title: 'Designing Deterministic Automation Pipelines',
      excerpt: 'How to build reliable AI automation systems with predictable workflow behavior.',
      link: 'https://github.com/gorghs',
    },
    {
      number: '02',
      date: 'Dec 10, 2024',
      readTime: '6 min read',
      title: 'Practical n8n Workflow Engineering',
      excerpt: 'Systematic strategies for modular, scalable and maintainable workflow logic.',
      link: 'https://github.com/gorghs',
    },
    {
      number: '03',
      ...
      title: 'Embedding-Based Semantic Search in Production',
      excerpt: 'Implementing lightweight semantic retrieval pipelines for real-world automation.',
      link: 'https://github.com/gorghs',
    },
  ];
