...
const CustomCursor: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = (e: Event) => {
      ...
      const skillTarget = target.closest('[data-cursor="skill"]');

      if (skillTarget) {
        gsap.to(cursor, { backgroundColor: '#ffffff', scale: 7.5, duration: 0.2 });
        gsap.to(follower, { borderColor: '#ffffff', scale: 2.2, duration: 0.2 });
        return;
      }
