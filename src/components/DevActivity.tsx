    ...
    const fetchGitHubData = async () => {
      try {
        ...
        try {
          ...
          const contribRes = await fetch('https://github-contributions-api.jogruber.de/v4/Gorghs');
          if (contribRes.ok) {
        ...
        try {
          ...
          // Local: http://localhost:8000/api/profile-views
          // Prod (via Vercel): /api/profile-views -> https://karthick-portfolio-api.onrender.com/api/profile-views
