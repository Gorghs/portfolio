...
const Hero: React.FC<HeroProps> = ({ startAnimation = false }) => {
  ...
  const resumeUrl = 'https://drive.google.com/file/d/1sDmWeSqvtOMQ5T_y_yvQ5CGSkNHFSHIk/view?usp=sharing';
          ...
          <div className="hidden md:flex gap-12">
            <div className="meta-item text-right">
              ...
              <p className="font-mono text-xs uppercase flex items-center gap-2">
                <FiGlobe className="w-3 h-3" /> IN, Chennai
              </p>
            </div>
            <div className="meta-item text-right">
        ...
        <div className="flex-1 flex flex-col justify-center items-center w-full relative">
          ...
          <div className="flex md:flex relative mt-12 md:absolute md:mt-0 md:-bottom-10 left-auto md:left-1/2 md:-translate-x-1/2 meta-item flex-col items-center z-10">
            ...
            <div className="flex gap-4 text-xs font-mono text-gray-500">
              <span className="flex items-center gap-1"><FiServer /> Automation</span>
              <span className="flex items-center gap-1"><FiDatabase /> Semantic Data</span>
              <span className="flex items-center gap-1"><FiCpu /> AI Systems</span>
            </div>
            <a
              href={resumeUrl}
              target="_blank"
              rel="noreferrer"
              className="mt-6 inline-flex items-center gap-2 border border-black/20 dark:border-white/20 px-4 py-2 text-xs font-mono uppercase tracking-widest text-black dark:text-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors"
            >
              Resume
            </a>
          </div>
        ...
        <div className="flex justify-between items-end pb-8 border-t border-black/10 dark:border-white/10 pt-6">
          <div className="meta-item w-1/3">
            ...
            <ul className="text-xs font-mono space-y-1">
              ...
              <li>Automation Engineer Roles</li>
            </ul>
          </div>
          ...
          <div className="meta-item w-1/3 text-right">
            ...
            <p className="text-xs font-mono">
              Portfolio v2.0 <br />
              Developed by Karthick Venkatachalem
            </p>
          </div>
        </div>
      </div>
