...
const Navigation: React.FC = () => {
  ...
  const downloadResume = () => {
    ...
    link.href = '/assets/Karthick_Venkatachalem_Resume.pdf';
    link.download = 'Karthick_Venkatachalem_Resume.pdf';
        ...
        <div className="max-w-[1800px] mx-auto flex items-center justify-between">
          ...
          >
            <div className="flex items-center tracking-tighter text-xl">
              ...
              <span className="font-light ml-1 dark:text-white">V</span>
