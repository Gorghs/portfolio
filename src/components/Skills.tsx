...
const Skills: React.FC = () => {
  ...
  // New Data Structure (AI Automation Focused) - 4 Categories
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'n8n Systems Engineering', level: 92 },
        { name: 'Automation Logic Engineering', level: 90 },
        { name: 'LLM Fine-Tuning (Small Models)', level: 84 },
        { name: 'Deterministic JSON Design', level: 88 },
      ],
    },
    {
      id: '02',
      ...
      skills: [
        { name: 'Node.js Backend Design', level: 86 },
        { name: 'Python Backend Systems', level: 90 },
        { name: 'API Orchestration', level: 88 },
        { name: 'MongoDB / MySQL', level: 82 },
        { name: 'SQL + NoSQL Modeling', level: 84 },
      ],
    },
    {
      id: '03',
      ...
      skills: [
        { name: 'Semantic Search & Embeddings', level: 91 },
        { name: 'Vector Similarity Pipelines', level: 88 },
        { name: 'Contextual Ranking Systems', level: 85 },
        { name: 'Inference Cost Optimization', level: 82 },
        { name: 'Retrieval System Stability', level: 84 },
      ],
    },
    {
      id: '04',
      ...
      skills: [
        { name: 'Linux-Based Development', level: 90 },
        { name: 'GitHub Collaboration', level: 88 },
        { name: 'Postman API Validation', level: 86 },
        { name: 'Neovim Workflow Setup', level: 83 },
        { name: 'System Design Thinking', level: 87 },
      ],
    },
  ];
  ...
  const logos = [
    ...
    { name: 'TailwindCSS', src: 'https://www.vectorlogo.zone/logos/tailwindcss/tailwindcss-icon.svg' },
        ...
        <div className="mb-20 px-6 md:px-12 border-b border-black/10 dark:border-white/10 pb-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-6">
            ...
            <p className="font-mono text-sm max-w-md text-gray-500 text-right pb-2">
              ...
              OPTIMIZED FOR AUTOMATION & INTELLIGENCE
            </p>
          </div>
        </div>
