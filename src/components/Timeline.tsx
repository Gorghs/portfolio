...
const milestones = [
    {
        year: '2023',
        title: 'Foundations',
        description: 'Began focused Linux-based development and backend-first problem solving with practical scripting and systems thinking.',
        tags: ['Linux', 'Python', 'Backend Basics']
    },
    {
        year: '2024',
        title: 'Automation Shift',
        description: 'Transitioned into workflow automation engineering with structured logic pipelines and backend-driven task orchestration.',
        tags: ['Automation', 'n8n', 'APIs']
    },
    {
        year: '2025',
        title: 'Semantic Systems',
        description: 'Built embedding-based retrieval and ranking workflows for intelligent filtering and contextual matching.',
        tags: ['Embeddings', 'Semantic Search', 'SBERT']
    },
    {
        year: '2025',
        title: 'Workflow Intelligence',
        description: 'Started building deterministic natural-language-to-workflow generation systems for real-world automation.',
        tags: ['LLM Fine-Tuning', 'JSON Constraints', 'AI Agents']
    },
    {
        year: '2026',
        title: 'Project Steve',
        description: 'Scaled a structured automation dataset pipeline and engineered memory-efficient output-safe workflow generation.',
        tags: ['Project Steve', 'n8n JSON', 'Deterministic Output']
    },
    {
        year: '2026',
        title: 'Applied AI Automation',
        description: 'Expanded into deployable automation architectures integrating backend logic, retrieval systems, and practical decision support.',
        tags: ['Automation Pipelines', 'System Design', 'Scalable AI']
    },
];
